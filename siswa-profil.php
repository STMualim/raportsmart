...
$ambil_data = query("SELECT * FROM siswa WHERE siswa.nis = '$user'");
?>
...
<head>
  ...
  <title>Profil Siswa | Smart-Rapor</title>
...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="siswa-nilai.php">
      ...
      <li class="nav-item">
        <a class="nav-link " href="siswa-profil.php">
          <i class="bi bi-person"></i>
          <span>Profil</span>
        </a>
      </li>
            ...
            <div class="card-body pt-3">
              ...
              <?php foreach($ambil_data as $row): ?>
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    <div class="col-lg-3 col-md-4 label ">Nomor Induk Siswa</div>
                    <div class="col-lg-9 col-md-8"><?php echo $row['nis'];?></div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php echo $row['kelas'];?></div>
                  </div>
                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Jenis Kelamin</div>
                    <div class="col-lg-9 col-md-8"><?php echo $row['kelamin'];?></div>
                  </div>
                  <div class="row">
