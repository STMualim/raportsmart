...
<head>
  ...
  <title>Siswa Dashboard | Smart-Rapor</title>
...
<body>
  ...
  <main id="main" class="main">
    ...
    <section class="section dashboard">
      <div class="row">
        <a href="siswa-nilai.php">
          <div class="col-xxl-4 col-xl-12">
            <div class="card info-card sales-card">
              <div class="card-body">
                <h5 class="card-title">Dashboard Siswa</h5>
        ...
        <a href="siswa-jadwal.php">
          <div class="col-xxl-4 col-xl-12">
            <div class="card info-card sales-card">
              <div class="card-body">
                <h5 class="card-title">Dashboard Siswa</span></h5>
