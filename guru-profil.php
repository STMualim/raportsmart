...
$ambil_data = query("SELECT * FROM guru WHERE guru.nip = '$user'");
?>
...
<head>
  ...
  <title>Profil Guru | Smart-Rapor</title>
...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="guru-nilai.php">
            ...
            <div class="card-body pt-3">
              ...
              <?php foreach($ambil_data as $row): ?>
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    <div class="col-lg-3 col-md-4 label ">Nomor Induk Pengajar</div>
                    <div class="col-lg-9 col-md-8"><?php echo $row['nip'];?></div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php echo $row['wali_kelas'];?></div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php echo $row['no_telp'];?></div>
                  </div>
                </div>
              <?php endforeach; ?>
              </div>
