...
<head>
  ...
  <title>Data Siswa | Smart-Rapor</title>
              ...
              <table class="table datatable">
                ...
                <tbody>
                  <tr>
                    ...
                    <td><?= $row["alamat"] ?></td>
                    <td>
                      <a href="admin-edit-siswa.php?nis=<?=$row['nis']?>" class="btn btn-primary btn-sm" role="button"><i class="bi bi-pencil"></i> Edit</a>
                      <a href="admin-hapus-siswa.php?nis=<?=$row['nis']?>" class="btn btn-danger btn-sm" role="button" onclick="return confirm('Hapus data siswa?')";><i class="bi bi-trash"></i> Hapus</a>
                    </td>
                  </tr>
                </tbody>
                <?php $angka++; ?>
